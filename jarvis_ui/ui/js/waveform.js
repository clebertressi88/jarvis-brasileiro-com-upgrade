...
window.setWaveformActive = setWaveformActive;
...
document.addEventListener("DOMContentLoaded", () => {
  startAudioStream();
  setWaveformActive(document.body.classList.contains("mode-original"));
});

document.addEventListener("visibilitychange", () => {
  setWaveformActive(
    !document.hidden && document.body.classList.contains("mode-original")
  );
});
